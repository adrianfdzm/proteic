...
var Globals = (function () {
    ...
    Globals.ASPECT_RATIO = 0.45;
    Globals.PROTEIC_CLASS_LINE = 'proteic-line';
...
var XAxis = (function (_super) {
    ...
    XAxis.prototype.render = function () {
        var computedWidth = this.config.get('computedWidth'), height = this.config.get('height'), xAxisFormat = this.config.get('xAxisFormat'), xAxisType = this.config.get('xAxisType'), xAxisLabel = this.config.get('xAxisLabel'), xAxisGrid = this.config.get('xAxisGrid');
    ...
    XAxis.prototype.makeItResponsive = function () {
...
var YAxis = (function (_super) {
    ...
    YAxis.prototype.render = function () {
        var computedWidth = this.config.get('computedWidth'), height = this.config.get('height'), yAxisFormat = this.config.get('yAxisFormat'), yAxisType = this.config.get('yAxisType'), yAxisLabel = this.config.get('yAxisLabel'), yAxisGrid = this.config.get('yAxisGrid');
    ...
    YAxis.prototype.makeItResponsive = function () {
...
var XYAxis = (function (_super) {
    ...
    XYAxis.prototype.range = function (xRange, yRange) {
    ...
    XYAxis.prototype.makeItResponsive = function () {
...
var Lineset = (function (_super) {
    ...
    Lineset.prototype.render = function () {
        ...
        this.lineGenerator = d3.line()
            .x(function (d) { return _this.xyAxes.x.xAxis.scale()(d[propertyX]); })
            .y(function (d) { return _this.xyAxes.y.yAxis.scale()(d[propertyY]); });
    };
    ...
    Lineset.prototype.makeItResponsive = function () {
        var _this = this;
...
var Pointset = (function (_super) {
    ...
    Pointset.prototype.makeItResponsive = function () {
        var _this = this;
        var propertyX = this.config.get('propertyX');
        var propertyY = this.config.get('propertyY');
...
var Areaset = (function (_super) {
    ...
    Areaset.prototype.makeItResponsive = function () {
        var _this = this;
        var height = this.config.get('height'), propertyX = this.config.get('propertyX'), propertyY = this.config.get('propertyY');
...
var Legend = (function (_super) {
    ...
    Legend.prototype.update = function (data) {
        ...
        var dataSeries = d3.nest()
            ...
            .entries(data), legend = null, entries = null, colorScale = this.config.get('colorScale'), height = this.config.get('height'), width = this.config.get('computedWidth');
    ...
    Legend.prototype.makeItResponsive = function () {
        var computedWidth = this.config.get('computedWidth');
...
var Container = (function () {
    function Container(config) {
        this.components = [];
        this.config = config;
        var selector = this.config.get('selector'), computedWidth = this.config.get('computedWidth'), height = this.config.get('height'), marginLeft = this.config.get('marginLeft'), marginRight = this.config.get('marginRight'), marginTop = this.config.get('marginTop'), marginBottom = this.config.get('marginBottom');
    ...
    Container.prototype.initializeContainer = function (selector, computedWidth, height, marginLeft, marginTop) {
    ...
    Container.prototype.responsive = function () {
        for (var i = 0; i < this.components.length; i++) {
            var component = this.components[i];
...
var SvgChart = (function () {
    ...
    SvgChart.prototype.registerResizeListener = function () {
        var _this = this;
        window.addEventListener('resize', function () {
            _this.detectDecreasing();
            _this.detectIncreasing();
        });
    };
    SvgChart.prototype.detectIncreasing = function () {
        var width = this.config.get('width');
        console.log('original width', width);
    };
    SvgChart.prototype.detectDecreasing = function () {
        var mLeft = this.config.get('marginLeft');
        var mRight = this.config.get('marginRight');
        var mTop = this.config.get('marginTop');
        var mBottom = this.config.get('marginBottom');
        var computedWidth = this.config.get('computedWidth') + mRight + mLeft, windowWidth = window.innerWidth;
        console.log('DECREASING: computed Width', computedWidth, 'window width', windowWidth);
        if (computedWidth > windowWidth)
            return;
        ...
        d3.select(this.config.get('selector') + ' svg')
...
var StackedArea = (function (_super) {
    ...
    StackedArea.prototype.loadConfigFromUser = function (userData) {
        var config = new Config(), selector = userData['selector'] || defaults$5.selector, marginTop = (userData['marginTop'] !== undefined) ? userData['marginTop'] : defaults$5.marginTop, marginLeft = (userData['marginLeft'] !== undefined) ? userData['marginLeft'] : defaults$5.marginLeft, marginRight = (userData['marginRight'] !== undefined) ? userData['marginRight'] : defaults$5.marginRight, marginBottom = (userData['marginBottom'] !== undefined) ? userData['marginBottom'] : defaults$5.marginBottom, width = userData['width']
            ? calculateWidth(userData['width'], selector) - marginLeft - marginRight
            : calculateWidth(defaults$5.width, selector) - marginLeft - marginRight, height = userData['height'] || defaults$5.height, xAxisType = userData['xAxisType'] || defaults$5.xAxisType, xAxisFormat = userData['xAxisFormat'] || defaults$5.xAxisFormat, xAxisLabel = userData['xAxisLabel'] || defaults$5.xAxisLabel, xAxisGrid = (typeof userData['xAxisGrid'] === 'undefined') ? defaults$5.xAxisGrid : userData['xAxisGrid'], yAxisType = userData['yAxisType'] || defaults$5.yAxisType, yAxisFormat = userData['yAxisFormat'] || defaults$5.yAxisFormat, yAxisLabel = userData['yAxisLabel'] || defaults$5.yAxisLabel, yAxisShow = userData['yAxisShow'] || defaults$5.yAxisShow, yAxisGrid = (typeof userData['yAxisGrid'] === 'undefined') ? defaults$5.yAxisGrid : userData['yAxisGrid'], colorScale = userData['colorScale'] || defaults$5.colorScale, onDown = userData['onDown'] || defaults$5.onDown, onUp = userData['onUp'] || defaults$5.onUp, onHover = userData['onHover'] || defaults$5.onHover, onClick = userData['onClick'] || defaults$5.onClick, onLeave = userData['onLeave'] || defaults$5.onLeave, legend = (typeof userData['legend'] === 'undefined') ? defaults$5.legend : userData['legend'], stacked = true, stack$$1 = d3.stack().value(function (d, k) { return d.value[k]; }).order(d3.stackOrderInsideOut).offset(d3.stackOffsetNone), propertyX = userData['propertyX'] || defaults$5.propertyX, propertyY = userData['propertyY'] || defaults$5.propertyY, propertyKey = userData['propertyKey'] || defaults$5.propertyKey;
        config.put('selector', selector);
        config.put('marginTop', marginTop);
        config.put('marginLeft', marginLeft);
        config.put('marginRight', marginRight);
...
var Sunburst = (function (_super) {
    ...
    Sunburst.prototype.loadConfigFromUser = function (userData) {
        var config = new Config(), selector = userData['selector'] || defaults$7.selector, marginTop = (userData['marginTop'] !== undefined) ? userData['marginTop'] : defaults$7.marginTop, marginLeft = (userData['marginLeft'] !== undefined) ? userData['marginLeft'] : defaults$7.marginLeft, marginRight = (userData['marginRight'] !== undefined) ? userData['marginRight'] : defaults$7.marginRight, marginBottom = (userData['marginBottom'] !== undefined) ? userData['marginBottom'] : defaults$7.marginBottom, width = userData['width']
            ? calculateWidth(userData['width'], selector) - marginLeft - marginRight
...
var Network = (function (_super) {
    ...
    Network.prototype.loadConfigFromUser = function (userData) {
        var config = new Config(), selector = userData['selector'] || defaults$8.selector, marginTop = (userData['marginTop'] !== undefined) ? userData['marginTop'] : defaults$8.marginTop, marginLeft = (userData['marginLeft'] !== undefined) ? userData['marginLeft'] : defaults$8.marginLeft, marginRight = (userData['marginRight'] !== undefined) ? userData['marginRight'] : defaults$8.marginRight, marginBottom = (userData['marginBottom'] !== undefined) ? userData['marginBottom'] : defaults$8.marginBottom, width = userData['width']
            ? calculateWidth(userData['width'], selector) - marginLeft - marginRight
